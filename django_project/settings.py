...
ALLOWED_HOSTS = ['mydjangoblog1.herokuapp.com']
...
#os.environ is added to hide credentials and pick them up from system environment variables

AWS_ACCESS_KEY_ID=os.environ.get('AWS_ACCESS_KEY_ID')
AWS_SECRET_ACCESS_KEY=os.environ.get('AWS_SECRET_ACCESS_KEY')
AWS_STORAGE_BUCKET_NAME=os.environ.get('AWS_STORAGE_BUCKET_NAME')

AWS_S3_FILE_OVERWRITE = False #done so that , anyone who uploads a file with same name does not gts overwritten
